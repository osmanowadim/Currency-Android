...
class GetAllLocalCurrencyUseCase @Inject constructor(
    threadExecutor: ThreadExecutor,
    postExecutionThread: PostExecutionThread,
    private val currencyRepository: CurrencyRepository
) : SingleUseCase<List<Currency>, Params?>(threadExecutor, postExecutionThread) {

    override fun buildUseCase(params: Params?): Single<List<Currency>> = currencyRepository.getAllLocalCurrencies()
